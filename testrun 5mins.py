...
for i in range(times):
    ...
    tws.reqRealTimeBars(tickerId,
        ...
        #data = pd.DataFrame(data,columns=["reqId", "time", "open", "high", "low", "close", "volume", "wap", "count"]).tail(1)
   ...
   # df.replace('[]', np.nan)
    ...
    if (signal == 'n'):
        ...
        #or
        #["ES", "FUT", "GLOBEX", "USD", '', '', '20170616', '50', "DU228380"]#
